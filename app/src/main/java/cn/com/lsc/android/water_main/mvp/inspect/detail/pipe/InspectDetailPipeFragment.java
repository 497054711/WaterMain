package cn.com.lsc.android.water_main.mvp.inspect.detail.pipe;
...
import cn.com.lsc.android.water_main.mvp.inspect.detail.pipe.present.InspectDetailPipePresent;
...
public class InspectDetailPipeFragment extends BaseFragment implements IInspectDetailPipeView {
    @BindView(R.id.lv_task_handle_pipe)
    RecyclerView lvTaskHandlePipe;
    private InspectDetailPipePresent taskDetailPresent;
    private TaskHandlePipeAdapter taskHandlePipeAdapter;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.inspet_detail_pipe, null);
        return view;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        taskDetailPresent = new InspectDetailPipePresent(this);
    ...
    class TaskHandlePipeAdapter extends RecyclerView.Adapter<MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            MyViewHolder holder = new MyViewHolder(LayoutInflater.from(
                    InspectDetailPipeFragment.this.getActivity()).inflate(R.layout.inspect_detail_pipe_item, parent,
                    false));
            return holder;
        }
        ...
        public void onBindViewHolder(final MyViewHolder holder, int position) {
            ...
            if (position < 5) {
                LoadLocalImageUtil.getInstance(InspectDetailPipeFragment.this.getActivity()).displayFromDrawable(damages[position], holder.ivDamage);
            }
            Glide.with(InspectDetailPipeFragment.this.getActivity()).load(R.drawable.user).asBitmap().centerCrop().into(new BitmapImageViewTarget( holder.ivUserIcon) {
                @Override
                protected void setResource(Bitmap resource) {
                    RoundedBitmapDrawable circularBitmapDrawable =
                            RoundedBitmapDrawableFactory.create(InspectDetailPipeFragment.this.getResources(), resource);
